...
import com.microsoft.projectoxford.face.samples.helper.filter;
import com.microsoft.projectoxford.face.samples.helper.wordActivity;
...
public class DetectionActivity extends AppCompatActivity {
    ...
    public void share(View view) {
        ...
        Intent intent1 = new Intent(this, filter.class);
        intent1.putExtra("image", byteArray)
                .putExtra("emotion",getEmotion_temp);
...
//        setAllButtonsEnabledStatus(false);
    ...
    //recommend part 구현할 것...
    static String getEmotion_temp;
    public void recommend(View view) {

        Intent intent = new Intent(DetectionActivity.this, wordActivity.class);
        //intent.putExtra("emotion",getEmotion_temp);
        intent.putExtra("emotion",getEmotion_temp);
    ...
    private class FaceListAdapter extends BaseAdapter {
        ...
        private String getEmotion(Emotion emotion)
        {
            ...
            if (emotion.surprise > emotionValue)
            {
                ...
                emotionType = "surprisal";
            }
            getEmotion_temp = emotionType;
